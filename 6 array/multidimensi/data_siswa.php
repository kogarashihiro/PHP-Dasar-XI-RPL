...
<body>
    ...
    <td>
        <a href="Edit.php?foto=<?=$students['5'] ?>&nisn=<?= $students['0']?>&nama=<?= $students['1']?>&kelas=<?= $students['2']?>&alamat=<?= $students['3']?>&gender=<?= $students['4']?>" class="btn btn-success" class="btn btn-success"><i class="bi bi-pencil"></i></a>
